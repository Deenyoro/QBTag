...
public class TableAdapterManager : Component
{
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	[DebuggerNonUserCode]
	private int UpdateUpdatedRows(usmanDataSet1 dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int result = 0;
		checked
		{
			if (_salesOrderLineTableAdapter != null)
			{
				DataRow[] updatedRows = dataSet.SalesOrderLine.Select(null, null, DataViewRowState.ModifiedCurrent);
				updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
				if ((updatedRows != null && 0 < updatedRows.Length) ? true : false)
				{
					result += _salesOrderLineTableAdapter.Update(updatedRows);
					allChangedRows.AddRange(updatedRows);
				}
			}
			if (_tblQrCodeTableAdapter != null)
			{
				DataRow[] updatedRows2 = dataSet.tblQrCode.Select(null, null, DataViewRowState.ModifiedCurrent);
				updatedRows2 = GetRealUpdatedRows(updatedRows2, allAddedRows);
				if ((updatedRows2 != null && 0 < updatedRows2.Length) ? true : false)
				{
					result += _tblQrCodeTableAdapter.Update(updatedRows2);
					allChangedRows.AddRange(updatedRows2);
				}
			}
			if (_partsTableAdapter != null)
			{
				DataRow[] updatedRows3 = dataSet.Parts.Select(null, null, DataViewRowState.ModifiedCurrent);
				updatedRows3 = GetRealUpdatedRows(updatedRows3, allAddedRows);
				if ((updatedRows3 != null && 0 < updatedRows3.Length) ? true : false)
				{
					result += _partsTableAdapter.Update(updatedRows3);
			...
			if (_orderInfoTableAdapter != null)
			{
				DataRow[] updatedRows5 = dataSet.OrderInfo.Select(null, null, DataViewRowState.ModifiedCurrent);
				updatedRows5 = GetRealUpdatedRows(updatedRows5, allAddedRows);
				if ((updatedRows5 != null && 0 < updatedRows5.Length) ? true : false)
				{
					result += _orderInfoTableAdapter.Update(updatedRows5);
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	[DebuggerNonUserCode]
	private int UpdateInsertedRows(usmanDataSet1 dataSet, List<DataRow> allAddedRows)
	{
		int result = 0;
		checked
		{
			if (_salesOrderLineTableAdapter != null)
			{
				DataRow[] addedRows = dataSet.SalesOrderLine.Select(null, null, DataViewRowState.Added);
				if ((addedRows != null && 0 < addedRows.Length) ? true : false)
				{
					result += _salesOrderLineTableAdapter.Update(addedRows);
					allAddedRows.AddRange(addedRows);
				}
			}
			if (_tblQrCodeTableAdapter != null)
			{
				DataRow[] addedRows2 = dataSet.tblQrCode.Select(null, null, DataViewRowState.Added);
				if ((addedRows2 != null && 0 < addedRows2.Length) ? true : false)
				{
					result += _tblQrCodeTableAdapter.Update(addedRows2);
					allAddedRows.AddRange(addedRows2);
				}
			}
			if (_partsTableAdapter != null)
			{
				DataRow[] addedRows3 = dataSet.Parts.Select(null, null, DataViewRowState.Added);
				if ((addedRows3 != null && 0 < addedRows3.Length) ? true : false)
				{
					result += _partsTableAdapter.Update(addedRows3);
			...
			if (_orderInfoTableAdapter != null)
			{
				DataRow[] addedRows5 = dataSet.OrderInfo.Select(null, null, DataViewRowState.Added);
				if ((addedRows5 != null && 0 < addedRows5.Length) ? true : false)
				{
					result += _orderInfoTableAdapter.Update(addedRows5);
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	[DebuggerNonUserCode]
	private int UpdateDeletedRows(usmanDataSet1 dataSet, List<DataRow> allChangedRows)
	{
		int result = 0;
		checked
		{
			...
			if (_partsTableAdapter != null)
			{
				DataRow[] deletedRows3 = dataSet.Parts.Select(null, null, DataViewRowState.Deleted);
				if ((deletedRows3 != null && 0 < deletedRows3.Length) ? true : false)
				{
					result += _partsTableAdapter.Update(deletedRows3);
					allChangedRows.AddRange(deletedRows3);
				}
			}
			if (_tblQrCodeTableAdapter != null)
			{
				DataRow[] deletedRows4 = dataSet.tblQrCode.Select(null, null, DataViewRowState.Deleted);
				if ((deletedRows4 != null && 0 < deletedRows4.Length) ? true : false)
				{
					result += _tblQrCodeTableAdapter.Update(deletedRows4);
					allChangedRows.AddRange(deletedRows4);
				}
			}
			if (_salesOrderLineTableAdapter != null)
			{
				DataRow[] deletedRows5 = dataSet.SalesOrderLine.Select(null, null, DataViewRowState.Deleted);
				if ((deletedRows5 != null && 0 < deletedRows5.Length) ? true : false)
				{
					result += _salesOrderLineTableAdapter.Update(deletedRows5);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public virtual int UpdateAll(usmanDataSet1 dataSet)
	{
		if (dataSet == null)
		{
