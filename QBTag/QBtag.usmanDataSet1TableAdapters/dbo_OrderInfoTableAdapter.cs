...
public class dbo_OrderInfoTableAdapter : Component
{
	...
	public virtual int Fill(usmanDataSet1.dbo_OrderInfoDataTable dataTable)
	{
	...
	[DebuggerNonUserCode]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual usmanDataSet1.dbo_OrderInfoDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		usmanDataSet1.dbo_OrderInfoDataTable dataTable = new usmanDataSet1.dbo_OrderInfoDataTable();
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	[DebuggerNonUserCode]
	public virtual int Update(usmanDataSet1.dbo_OrderInfoDataTable dataTable)
	{
