...
public class tblQrCodeTableAdapter : Component
{
	...
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual int Fill(usmanDataSet.tblQrCodeDataTable dataTable)
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
	public virtual usmanDataSet.tblQrCodeDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		usmanDataSet.tblQrCodeDataTable dataTable = new usmanDataSet.tblQrCodeDataTable();
	...
	[HelpKeyword("vs.data.TableAdapter")]
	[DebuggerNonUserCode]
	public virtual int Update(usmanDataSet.tblQrCodeDataTable dataTable)
	{
